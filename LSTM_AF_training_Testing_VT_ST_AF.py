...
model = Sequential()
model.add(LSTM(64,input_dim=169))  # try using a LSTM instead, for fun
...
# In[ ]:
model=load_model('LSTMcheckpoint-935.hdf5')

start_time1 = time.time()
y_pred = model.predict(X_test,batch_size=1000)
np.savetxt('./OUTPUTS/LSTMexpected.txt', y_test1, fmt='%01d')
np.savetxt('./OUTPUTS/LSTMpredicted.txt', y_pred.round(), fmt='%01d')
